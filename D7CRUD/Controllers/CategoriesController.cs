    ...
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create(CategoryViewModel _CategoryViewModel)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    _CategoryViewModel.Files.CopyTo(_MemoryStream);
                    _Category.DocByte = _MemoryStream.ToArray();
                }
                _Category.FileName = _CategoryViewModel.Files.FileName;
                _Category.FileType = _CategoryViewModel.Files.ContentType;
